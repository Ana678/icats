				...
				<div class="card card-bordered" style="border-radius:40px;">
					...
					<div class="card-body">
						...
						<div class="row align-center justify-content-center">
							...
							<button type="button" class="btn btn-rounded btn-primary mb-3 ml-2 mr-2" style="border-radius:40px;" onclick="location.href='addEstado.php?addByListar=<?php echo $resultado['GAT_CODIGO']; ?>';">NOVO ESTADO<i class="ti-plus"></i></button>
						</div>
					</div>
				</div>
			</div>
